...
local y2w = 255.0
local z2w = 255.0
v = s_dist3( x1, y1, z1, x2, y2, z2 ) 
util.msg("to black ", s_dist3( x1, y1, z1, x2, y2, z2 ))
util.msg("to white ", s_dist3( x1, y1, z1, x2w, y2w, z2w ))
--util.msg(util.linterp( 0.0, 255.0, math.min( v/440, 1.0 ) ) )
