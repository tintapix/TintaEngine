...
local kernel = "gpu/channel_to_channel.cl"

ocl.create( kernel, "image" )


local PathIn = "c:/foto/test10.png"
...
ocl.setvalue(kernel,3) -- replace
ocl.setvalue(kernel,1) -- with
--ocl.setvalue( kernel,100.0 ) --invertValue = 0 default or 255

ocl.setvalue(kernel, c_channels( image.selected() ))
