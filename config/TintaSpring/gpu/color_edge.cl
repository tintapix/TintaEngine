...
__kernel void image( __global unsigned char *write, const __global unsigned char *read, int w, int h, int channels, float threshold ) {  
	...
	if( colorL > -1 )
	{
		...
		len += distance( (float3)( r1, g1,b1) , (float3)( RCur, GCur,BCur) );
