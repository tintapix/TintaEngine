...
local kernelName = "gpu/color_to_alpha.cl"
...
local PathIn = "C:/foto/rez/3132729095_2022112164810112_8682.png"
...
ocl.setvalue(kernelName,144)
ocl.setvalue(kernelName,139)
ocl.setvalue(kernelName,146)
