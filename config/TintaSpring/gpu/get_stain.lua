...
-- smooth
local kernelName = "gpu/get_stain.cl"

-- smooth
ocl.create( kernelName, "smooth" )
-- monochrome rough
--ocl.create( kernelName, "rough" )

local PathIn = "c:/scenes/man_fire.png"
...
ocl.setvalue(kernelName,0)
ocl.setvalue(kernelName,0)
-- mix (  255.f, 0, min( distance( v1, v2 ) / factor, 1.f ) )
ocl.setvalue(kernelName,140.0) -- max 441.6729 (black - white)
