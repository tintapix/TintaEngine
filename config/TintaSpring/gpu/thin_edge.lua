...
--[[
	задает а = 0 всем соседним с а < 255 пикселям
]]--


local kernelName = "gpu/thin_edge.cl"
...
local PathIn = "C:/foto/rez/hand_1.png"
...
for i = 1, stages do
	...
	imgIndex = 1
	ocl.execute( kernelName, w*h,0,0,  imgIndex, 0 )
	image.erase(idRead)
	idRead = idWrite
