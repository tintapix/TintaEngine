...
{	
	...
	{	
        ...
        virtual const tintaUInt8Image *getNextImg(m_uint32 &index)const = 0;

        virtual const tintaUInt8Image *getFirstImg(m_uint32 &index)const = 0;

        virtual tintaVector2f  getPosition(m_uint32 &index)const = 0;

        virtual void  setPosition(m_uint32 &index, const tintaVector2f &pos ) = 0;
