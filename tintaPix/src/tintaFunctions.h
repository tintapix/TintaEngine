	...
	namespace Tinta	{
            ...
            namespace TintaImageLua {
                ...
                */
                ...
                /*
                    @name image.poster
                    @description    Pixel gets major pixel
                ...
                */
                ...
                /*
                    ...
                    @description Draws point in selected image
                ...
                */
                ...
                /*
                    ...
                    @description Draws point in the selected image
                    @param Int x coordinate
                    @param Int y coordinate
                    @param Real r
                    @param Real g
            ...
            namespace tintaFontFunctions {
                ...
                */
                ...
                /*
                @name image.remove
                @description Delete all image data and free memory
                */
        ...
        */
		...
		/*
            @name main.f
			@description Executs Script file on the first available unit
