...
#define POINT_filllayer "filllayer"
    ...
    /*
    @name point.swap
    @description Swaps layers in places
    @param name1 - first points layer name
    @param name2 - second points layer name
    */
...
/*
@name d3.layerback
@description Move layer back in the render queue on 1 position
...
/*
@name d3.layerfront
@description Move layer front in the render queue on 1 position
@param Object type: "back", "front"
@param Object name
*/
...
/*
@name d3.layerswap
@description Exchange layers positions in the render queue
@param Object type: "back", "front"
@param Object name1
@param Object name2
*/
